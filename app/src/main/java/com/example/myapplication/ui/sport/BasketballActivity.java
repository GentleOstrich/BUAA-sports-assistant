...
public class BasketballActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_cal = findViewById(R.id.cal_basketball);
        et_time = findViewById(R.id.time_basketball);
        btn_submit = findViewById(R.id.btn_basketball);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_basketball) {
            String dis = "";
