...
public class FootballActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sport_football);
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setHomeAsUpIndicator(R.drawable.ic_back); //修改actionbar左上角返回按钮的图标

        et_cal = findViewById(R.id.cal_football);
        et_time = findViewById(R.id.time_football);
        btn_submit = findViewById(R.id.btn_football);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_football) {
            String dis = "";
            ...
            if (cal.equals("") || time.equals("")) {
                ...
                if (!account.equals("none")) {
                    ...
                    for (UserBean userBean : userBeans) {
                        SportsBean sportsBean = new SportsBean("足球", dis, cal, time, userBean);
