...
public class SwimActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_cal = findViewById(R.id.cal_swim);
        et_time = findViewById(R.id.time_swim);
        btn_submit = findViewById(R.id.btn_swim);
