...
public class TennisActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sport_tennis);
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setHomeAsUpIndicator(R.drawable.ic_back); //修改actionbar左上角返回按钮的图标

        et_cal = findViewById(R.id.cal_tennis);
        et_time = findViewById(R.id.time_tennis);
        btn_submit = findViewById(R.id.btn_tennis);
            ...
            if (cal.equals("") || time.equals("")) {
                ...
                if (!account.equals("none")) {
                    ...
                    for (UserBean userBean : userBeans) {
                        SportsBean sportsBean = new SportsBean("网球", dis, cal, time, userBean);
