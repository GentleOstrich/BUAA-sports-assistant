...
public class VolleyballActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sport_volleyball);
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setHomeAsUpIndicator(R.drawable.ic_back); //修改actionbar左上角返回按钮的图标

        et_cal = findViewById(R.id.cal_volleyball);
        et_time = findViewById(R.id.time_volleyball);
        btn_submit = findViewById(R.id.btn_volleyball);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_volleyball) {
            String dis = "";
