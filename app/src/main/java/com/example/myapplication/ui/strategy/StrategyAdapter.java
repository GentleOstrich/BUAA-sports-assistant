...
public class StrategyAdapter extends ArrayAdapter<StrategyBean> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView image = view.findViewById(R.id.image_strategy);
        ...
        if (strategyBean.getImage() != null) {
            byte[] decodedBytes = Base64.decode(strategyBean.getImage(), Base64.DEFAULT);
